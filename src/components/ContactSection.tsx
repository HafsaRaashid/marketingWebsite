      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 text-lg">
            Have questions about our services or want to join our rescue
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-white rounded-2xl shadow-md p-8 mb-8">
              <h3 className="text-2xl font-bold text-petblue-dark mb-6">
                Contact Information
              </h3>

              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-petorange/10 p-3 rounded-full mr-4">
                    <MapPin className="h-5 w-5 text-petorange" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-petblue-dark">
                      Our Location
                    </h4>
                ...
                <div className="flex items-start">
                  <div className="bg-petorange/10 p-3 rounded-full mr-4">
                    <Mail className="h-5 w-5 text-petorange" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-petblue-dark">
                      Email Us
                    </h4>
                    <p className="text-gray-600">pawsome469@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label
                    htmlFor="name"
                    className="text-sm font-medium text-petblue-dark"
                  >
                    Your Name
                  </label>
                  <Input
              ...
              <Button
                type="submit"
                className="w-full bg-orange-400 hover:bg-petorange-dark text-white"
